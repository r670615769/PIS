...
return  array(
    ...
    'LOAD_EXT_FILE'         => 'function', // auto load ext file the file is custome
    'APP_TAGS_ON'           => true, // 系统标签扩展开关
    'APP_SUB_DOMAIN_DEPLOY' => false,   // 是否开启子域名部署
    'APP_SUB_DOMAIN_RULES'  => array(), // 子域名部署规则
    'APP_SUB_DOMAIN_DENY'   => array(), //  子域名禁用列表
    'APP_GROUP_LIST'        => 'Frontend,Backend',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    'DEFAULT_GROUP'         => 'Backend',  // 默认分组
    'DEFAULT_MODULE'        => 'UserAndUserGroup', // 默认模块名称
